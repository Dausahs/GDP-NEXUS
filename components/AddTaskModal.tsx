...
export default function AddTaskModal({ eventId, teamMembers, userRole }: { eventId: string, teamMembers: any[], userRole?: string }) {
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4 mb-10">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-mono text-cyan-neon uppercase tracking-[0.2em]">
                                    {isRequestMode ? 'Submit a task request for approval' : 'Create a new task for this project'}
                                </p>
                            </div>
                        </div>
                        ...
                        <form action={handleSubmit} className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    >
                                        <option value="Graphics" className="bg-[#161B22]">Graphics</option>
                            ...
                            {!isRequestMode && (
                                <div className="space-y-2">
                                    ...
                                    <div className="bg-white/5 border border-white/5 rounded-2xl p-4 min-h-[120px] max-h-[200px] overflow-y-auto custom-scrollbar">
                            ...
                            <div className="flex gap-4 pt-6">
                                ...
                                <button 
                                    type="submit" 
                                    disabled={isPending}
                                    className="flex-[2] bg-cyan-neon text-black px-8 py-4 rounded-2xl font-display font-bold text-sm shadow-[0_0_30px_rgba(0,245,255,0.2)] hover:scale-[1.02] active:scale-95 transition-all uppercase tracking-widest disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {isPending ? (isRequestMode ? 'SUBMITTING...' : 'CREATING...') : (isRequestMode ? 'SUBMIT REQUEST' : 'CREATE TASK')}
                                </button>
                            </div>
                        </form>
                    </div>
